...
real*8,  intent(in)    :: gm1                    !< ratio of specific heats - 1d0
...
real*8,  intent(inout) :: dfdq(nq,nq)            !< Flux Jacobian
!
! local variables
!
real*8  :: dp(nq)
real*8  :: irho,ep,uu,u,v,w,e,drvel_dq1,drvel_dqip
integer :: ip,jp,dir
!
ip         = idir + 1
irho       = 1d0/q(1)
